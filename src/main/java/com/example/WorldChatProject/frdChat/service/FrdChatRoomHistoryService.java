...
public class FrdChatRoomHistoryService {
    ...
    //채팅방에 접속한 사람 넣기
    public void enteredRoom(String user, long roomId, String sessionId, StompHeaderAccessor stompHeaderAccessor) {
        System.out.println("이건 스톰프 헤더 엑세서" + stompHeaderAccessor);

//        Optional<FrdChatRoomHistory> existingSession = frdChatRoomHistoryRepository.findByRoomIdAndUserNickName(roomId, user);
//
//        if(existingSession.isPresent()) {
//            String existingSessionId = existingSession.get().getSessionId();
//
//
//
//
