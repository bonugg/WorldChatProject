...
//    // 정확히는 PrincipalDetails 안에 ChatUser 객체가onPrincipal PrincipalDetails principalDetails){
//
//        model.addAttribute("list", chatServiceMain.findAllRoom()); 담기고, 이것을 가져오면 된다.
////    @GetMapping("/")
////    public String goChatRoom(Model model, @Authenticati
//
